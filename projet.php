...
<body class="bg-light">
      ...
      <div class="container-fluid">
        ...
        <ul>
          <div class="d-lg-inline-flex d-md-block d-sm-inline-flex d-inline-flex mt-lg-3 div1">
            <li class="nav nav-item navi me-5"><a class="nav-link acceuil" id="acceuil" href="projet.php">Acceuil</a></li>
        ...
        <li class="nav nav-item navi me-5"><a class="nav-link " href="page.php">Page d'administrateur</a></li>
  ...
  <main class="w-100">
    <div>
      <div class="text-center mt-5">
        ...
        <a href="inscription.php" class="btn btn-primary btn-lg">Inscrivez-Vous Dans le site</a>
      </div>
  </main>
  <section class="mt-2 ">
  ...
  <div class="container mt-4" id="acceuil">
    <div class="row">
      <div class="col-lg-8">
